...
void setupGame(int height, int width, int &x, int &y, int &prevX, int &prevY, int &score, bool &modeHard, int round, int Map, int &last, int &dir, int &hour,int &minute, int &second, int &millisec, int obj[27], int randomObj, char idxObj[][widthB+2], int idxNum[][widthB+2], int line[][widthB+2], int lineOut[][widthB+3], int lineEnd[][widthB+2], int greenBlock[][widthB+2], int redBlock[][widthB+2])
{
	x = 1;
	y = 1;
    prevX = 200;
